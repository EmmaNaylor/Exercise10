...
# print(len(fileNamesList)) - NO LONGER NEEDED - USED TO TEST LENGTH OF LIST AND CONFIRM FILE SIZES LESS THAN 0 DELETED
# print(len(fileLengthList)) - NO LONGER NEEDED - USED TO TEST LENGTH OF LIST AND CONFIRM FILE SIZES LESS THAN 0 DELETED

print("\n\n\n\n----------------------------------------------------------------------------------------------\n\n\n\n")

# Dictionary Extension to convert lists to dictionary
mydict = {fileNamesList[element]: fileLengthList[element] for element in range(len(fileNamesList))}
